...
const siteData = deserializeFunctions(JSON.parse('{"lang":"en-US","dir":"ltr","title":"首页","description":"A VitePress Site","base":"/","head":[],"router":{"prefetchLinks":true},"appearance":true,"themeConfig":{"outlineTitle":"页面导航","returnToTopLabel":"回到顶部","sidebarMenuLabel":"菜单","nav":[{"text":"文档","link":"/markdown-examples"},{"text":"文档","link":"/markdown-examples"}],"sidebar":[{"text":"欢迎使用","collapsed":true,"items":[{"text":"使用说明","link":"/markdown-examples"},{"text":"快速开始","link":"/api-examples"}]},{"text":"环境配置","collapsed":true,"items":[{"text":"Node环境配置","link":"/pz/node_a"},{"text":"codex 中转配置","link":"/pz/codex_a"},{"text":"claude 中转配置","link":"/pz/claude_a"}]},{"text":"插件安装","collapsed":true,"items":[{"text":"Codex","collapsed":true,"items":[{"text":"Codex CLI","link":"/codex/codex_a"},{"text":"Codex IDE 插件","link":"/codex/codex_b"},{"text":"Codex 桌面端","link":"/codex/codex_c"}]},{"text":"Claude","collapsed":true,"items":[{"text":"Claude CLI","link":"/claude/claude_a"},{"text":"Claude IDE 插件","link":"/claude/claude_b"},{"text":"Claude 桌面端","link":"/claude/claude_c"}]}]}],"socialLinks":[{"icon":"github","link":"https://github.com/vuejs/vitepress"}]},"locales":{},"scrollOffset":134,"cleanUrls":false,"additionalConfig":{}}'));
...
const NotFound = /* @__PURE__ */ _export_sfc(_sfc_main$13, [["__scopeId", "data-v-829df670"]]);
...
const VPDocOutlineItem = /* @__PURE__ */ _export_sfc(_sfc_main$12, [["__scopeId", "data-v-1ce71065"]]);
...
const VPDocAsideOutline = /* @__PURE__ */ _export_sfc(_sfc_main$11, [["__scopeId", "data-v-60d5052e"]]);
...
const VPDocFooterLastUpdated = /* @__PURE__ */ _export_sfc(_sfc_main$Z, [["__scopeId", "data-v-3c637f39"]]);
...
const VPDoc = /* @__PURE__ */ _export_sfc(_sfc_main$X, [["__scopeId", "data-v-7011f0d8"]]);
...
const VPButton = /* @__PURE__ */ _export_sfc(_sfc_main$W, [["__scopeId", "data-v-01bff58b"]]);
...
const _sfc_main$U = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-e62e4946><div class="container" data-v-e62e4946><div class="main" data-v-e62e4946>`);
      ...
      ssrRenderSlot(_ctx.$slots, "home-hero-info", {}, () => {
        ...
        if (__props.name) {
          _push(`<span class="name clip" data-v-e62e4946>${__props.name ?? ""}</span>`);
        } else {
          _push(`<!---->`);
        }
        if (__props.text) {
          _push(`<span class="text" data-v-e62e4946>${__props.text ?? ""}</span>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</h1>`);
        if (__props.tagline) {
          _push(`<p class="tagline" data-v-e62e4946>${__props.tagline ?? ""}</p>`);
        } else {
          _push(`<!---->`);
        }
      }, _push, _parent);
...
const VPHero = /* @__PURE__ */ _export_sfc(_sfc_main$U, [["__scopeId", "data-v-e62e4946"]]);
    ...
    return (_ctx, _push, _parent, _attrs) => {
      if (unref(fm).hero) {
        _push(ssrRenderComponent(VPHero, mergeProps({
          ...
          "home-hero-actions-before-actions": withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ssrRenderSlot(_ctx.$slots, "home-hero-actions-before-actions", {}, null, _push2, _parent2, _scopeId);
            } else {
              return [
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$_, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<article class="box" data-v-e5511d04${_scopeId}>`);
            if (typeof __props.icon === "object" && __props.icon.wrap) {
              _push2(`<div class="icon" data-v-e5511d04${_scopeId}>`);
              ...
              _push2(`<div class="icon" data-v-e5511d04${_scopeId}>${__props.icon ?? ""}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<h2 class="title" data-v-e5511d04${_scopeId}>${__props.title ?? ""}</h2>`);
            if (Array.isArray(__props.details)) {
              _push2(`<ul class="details" data-v-e5511d04${_scopeId}><!--[-->`);
              ssrRenderList(__props.details, (item) => {
                _push2(`<li data-v-e5511d04${_scopeId}>${item ?? ""}</li>`);
              });
              _push2(`<!--]--></ul>`);
            } else if (__props.details) {
              _push2(`<p class="details" data-v-e5511d04${_scopeId}>${__props.details ?? ""}</p>`);
            } else {
              _push2(`<!---->`);
            }
            if (__props.linkText) {
              _push2(`<div class="link-text" data-v-e5511d04${_scopeId}><p class="link-text-value" data-v-e5511d04${_scopeId}>${ssrInterpolate(__props.linkText)} <span class="vpi-arrow-right link-text-icon" data-v-e5511d04${_scopeId}></span></p></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</article>`);
...
const VPFeature = /* @__PURE__ */ _export_sfc(_sfc_main$S, [["__scopeId", "data-v-e5511d04"]]);
...
const VPHome = /* @__PURE__ */ _export_sfc(_sfc_main$O, [["__scopeId", "data-v-bb6342a6"]]);
const _sfc_main$N = {};
...
const VPContent = /* @__PURE__ */ _export_sfc(_sfc_main$M, [["__scopeId", "data-v-9dc86fcc"]]);
...
const VPFooter = /* @__PURE__ */ _export_sfc(_sfc_main$L, [["__scopeId", "data-v-c3855bb3"]]);
...
const VPLocalNavOutlineDropdown = /* @__PURE__ */ _export_sfc(_sfc_main$K, [["__scopeId", "data-v-0bf0e06f"]]);
...
const VPLocalNav = /* @__PURE__ */ _export_sfc(_sfc_main$J, [["__scopeId", "data-v-db738f89"]]);
function useNav() {
...
const VPSwitch = /* @__PURE__ */ _export_sfc(_sfc_main$I, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-1d5665e3"]]);
...
const _sfc_main$F = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "VPMenuLink" }, _attrs))} data-v-867c295f>`);
      _push(ssrRenderComponent(_sfc_main$_, mergeProps(_ctx.$attrs, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span data-v-867c295f${_scopeId}>${__props.item.text ?? ""}</span>`);
          } else {
            return [
              createVNode("span", {
...
const VPMenuLink = /* @__PURE__ */ _export_sfc(_sfc_main$F, [["__scopeId", "data-v-867c295f"]]);
...
const VPMenuGroup = /* @__PURE__ */ _export_sfc(_sfc_main$E, [["__scopeId", "data-v-1963e1bb"]]);
...
const VPMenu = /* @__PURE__ */ _export_sfc(_sfc_main$D, [["__scopeId", "data-v-25a6cce8"]]);
...
const VPFlyout = /* @__PURE__ */ _export_sfc(_sfc_main$C, [["__scopeId", "data-v-42cb505d"]]);
...
const VPSocialLink = /* @__PURE__ */ _export_sfc(_sfc_main$B, [["__scopeId", "data-v-591a6b30"]]);
...
const VPSocialLinks = /* @__PURE__ */ _export_sfc(_sfc_main$A, [["__scopeId", "data-v-d07f11e6"]]);
const _sfc_main$z = /* @__PURE__ */ defineComponent({
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              if (unref(localeLinks).length && unref(currentLang).label) {
                _push2(`<div class="group translations" data-v-562c832a${_scopeId}><p class="trans-title" data-v-562c832a${_scopeId}>${ssrInterpolate(unref(currentLang).label)}</p><!--[-->`);
              ...
              if (unref(site).appearance && unref(site).appearance !== "force-dark" && unref(site).appearance !== "force-auto") {
                _push2(`<div class="group" data-v-562c832a${_scopeId}><div class="item appearance" data-v-562c832a${_scopeId}><p class="label" data-v-562c832a${_scopeId}>${ssrInterpolate(unref(theme2).darkModeSwitchLabel || "Appearance")}</p><div class="appearance-action" data-v-562c832a${_scopeId}>`);
              ...
              if (unref(theme2).socialLinks) {
                _push2(`<div class="group" data-v-562c832a${_scopeId}><div class="item social-links" data-v-562c832a${_scopeId}>`);
...
const VPNavBarExtra = /* @__PURE__ */ _export_sfc(_sfc_main$z, [["__scopeId", "data-v-562c832a"]]);
const _sfc_main$y = /* @__PURE__ */ defineComponent({
...
const _sfc_main$x = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$_, mergeProps({
        class: { VPNavBarMenuLink: true, active: isActiveLink.value },
        href: href.value,
        target: __props.item.target,
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span data-v-6dd25bb8${_scopeId}>${__props.item.text ?? ""}</span>`);
          } else {
            return [
              createVNode("span", {
                innerHTML: __props.item.text
...
const VPNavBarMenuLink = /* @__PURE__ */ _export_sfc(_sfc_main$x, [["__scopeId", "data-v-6dd25bb8"]]);
const _sfc_main$w = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(VPFlyout, mergeProps({
        class: { VPNavBarMenuGroup: true, active: isActiveGroup.value },
...
const VPNavBarMenu = /* @__PURE__ */ _export_sfc(_sfc_main$v, [["__scopeId", "data-v-39714824"]]);
...
const VPNavBarAskAiButton = /* @__PURE__ */ _export_sfc(_sfc_main$u, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-4eb17e89"]]);
const _sfc_main$t = /* @__PURE__ */ defineComponent({
...
const VPNavBarSearchButton = /* @__PURE__ */ _export_sfc(_sfc_main$t, [["__scopeId", "data-v-baa3be99"]]);
const _sfc_main$s = /* @__PURE__ */ defineComponent({
...
const VPNavBarSearch = /* @__PURE__ */ _export_sfc(_sfc_main$s, [["__scopeId", "data-v-2fc7f2c6"]]);
const _sfc_main$r = /* @__PURE__ */ defineComponent({
    ...
    return (_ctx, _push, _parent, _attrs) => {
      if (unref(localeLinks).length && unref(currentLang).label) {
        _push(ssrRenderComponent(VPFlyout, mergeProps({
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="items" data-v-fafa8c23${_scopeId}><p class="title" data-v-fafa8c23${_scopeId}>${ssrInterpolate(unref(currentLang).label)}</p><!--[-->`);
              ssrRenderList(unref(localeLinks), (locale) => {
                _push2(ssrRenderComponent(VPMenuLink, {
                  item: locale,
                  lang: locale.lang,
...
const VPNavBarTranslations = /* @__PURE__ */ _export_sfc(_sfc_main$p, [["__scopeId", "data-v-fafa8c23"]]);
const _sfc_main$o = /* @__PURE__ */ defineComponent({
  __name: "VPNavBar",
  __ssrInlineRender: true,
  props: {
...
const VPNavBar = /* @__PURE__ */ _export_sfc(_sfc_main$o, [["__scopeId", "data-v-9ca1369d"]]);
...
const VPNavScreenMenuLink = /* @__PURE__ */ _export_sfc(_sfc_main$m, [["__scopeId", "data-v-b924ab8a"]]);
const _sfc_main$l = /* @__PURE__ */ defineComponent({
...
const VPNavScreenMenuGroupLink = /* @__PURE__ */ _export_sfc(_sfc_main$l, [["__scopeId", "data-v-ecf4b472"]]);
const _sfc_main$k = /* @__PURE__ */ defineComponent({
...
const VPNavScreenTranslations = /* @__PURE__ */ _export_sfc(_sfc_main$g, [["__scopeId", "data-v-a4d9b172"]]);
const _sfc_main$f = /* @__PURE__ */ defineComponent({
  __name: "VPNavScreen",
  __ssrInlineRender: true,
  props: {
...
const VPNavScreen = /* @__PURE__ */ _export_sfc(_sfc_main$f, [["__scopeId", "data-v-05f3d7bc"]]);
const _sfc_main$e = /* @__PURE__ */ defineComponent({
  __name: "VPNav",
  __ssrInlineRender: true,
  setup(__props) {
...
const VPSidebar = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["__scopeId", "data-v-af661f50"]]);
const _sfc_main$a = /* @__PURE__ */ defineComponent({
  __name: "VPSkipLink",
  __ssrInlineRender: true,
  setup(__props) {
...
const VPSkipLink = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["__scopeId", "data-v-331ec75c"]]);
...
const Layout = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["__scopeId", "data-v-0cf61682"]]);
const GridSettings = {
  xmini: [[0, 2]],
  mini: [],
  small: [
